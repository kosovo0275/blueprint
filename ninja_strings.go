...
// parseNinjaString parses an unescaped ninja
// string (i.e. all $<something> occurrences are
// expected to be variables or $$) and returns a
// list of the variable names that the string
// references.

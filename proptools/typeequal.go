...
// TypeEqual takes two property structs, and returns
// true if they are of equal type, any embedded
// pointers to structs or interfaces having matching
// nilitude, and any interface{} values in any
// embedded structs, pointers to structs, or interfaces
// are also of equal type.
...
// concreteType returns true if v recursively contains
// no interfaces

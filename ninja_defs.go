...
// Deps indicates the dependency file format that
// Ninja should expect to be output by a compiler.
type Deps int
...
// PoolParams contains the set of parameters that
// make up a Ninja pool definition.
type PoolParams struct {
	Comment string // The comment that will appear above the definition.
	Depth   int    // The Ninja pool depth.
}

// RuleParams contains the set of parameters that
// make up a Ninja rule definition.
...
// BuildParams contains the set of parameters that
// make up a Ninja build statement. Each field
// except for Args corresponds with a part of the
// Ninja build statement. The Args field contains
// variable names and values that are set within
// the build statement's scope in the Ninja file.
...
// poolDef describes a pool definition. It does
// not include the name of the pool.
type poolDef struct {
	Comment string
	Depth   int
}
...
// ruleDef describes a rule definition. It does
// not include the name of the rule.
type ruleDef struct {
...
// buildDef describes a build target definition.

...
// PropertyStruct returns the PropertyStruct
// associated with a property struct type. The
...
// removeEmptyPropertyStructs removes any property
// structs that have no exported fields
...
// collapseDuplicatePropertyStructs squashes duplicates
// of the same property struct into single entries
...
// collapseNestedPropertyStructs finds all property
// structs that only contain structs, and move their
// children up one with a prefixed name
...
// ModuleType contains the info about a module type
// that is relevant to generating documentation.
type ModuleType struct {
	// Name is the string that will appear in Blueprints
	// files when defining a new module of this type.
	Name string

	// Text is the contents of the comment documenting
	// the module type
	Text string

	// PropertyStructs is a list of PropertyStruct
	// objects that contain information about each
	// property struct that is used by the module type,
	// containing all properties that are valid for the
	// module type.

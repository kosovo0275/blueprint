...
// removeAbandonedFilesUnder removes any files that
// appear in the Ninja log, and are prefixed with
// one of the `under` entries, but that are not
// currently build targets.
